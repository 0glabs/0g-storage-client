...
func (c *ZgsClient) GetStatus(ctx context.Context) (status Status, err error) {
	err = c.wrapError(c.CallContext(ctx, &status, "zgs_getStatus"), "zgs_getStatus")
	return
}
...
func (c *ZgsClient) GetFileInfoByTxSeq(ctx context.Context, txSeq uint64) (file *FileInfo, err error) {
	err = c.wrapError(c.CallContext(ctx, &file, "zgs_getFileInfoByTxSeq", txSeq), "zgs_getFileInfoByTxSeq")
	return
}
...
func (c *ZgsClient) UploadSegment(ctx context.Context, segment SegmentWithProof) (ret int, err error) {
	err = c.wrapError(c.CallContext(ctx, &ret, "zgs_uploadSegment", segment), "zgs_uploadSegment")
	return
}
...
func (c *ZgsClient) UploadSegments(ctx context.Context, segments []SegmentWithProof) (ret int, err error) {
	err = c.wrapError(c.CallContext(ctx, &ret, "zgs_uploadSegments", segments), "zgs_uploadSegments")
	return
}
...
func (c *ZgsClient) DownloadSegment(ctx context.Context, root common.Hash, startIndex, endIndex uint64) (data []byte, err error) {
	err = c.wrapError(c.CallContext(ctx, &data, "zgs_downloadSegment", root, startIndex, endIndex), "zgs_downloadSegment")
	if len(data) == 0 {
		return nil, err
	}
	return
...
func (c *ZgsClient) DownloadSegmentWithProof(ctx context.Context, root common.Hash, index uint64) (segment *SegmentWithProof, err error) {
	err = c.wrapError(c.CallContext(ctx, &segment, "zgs_downloadSegmentWithProof", root, index), "zgs_downloadSegmentWithProof")
	return
}
...
func (c *ZgsClient) GetShardConfig(ctx context.Context) (shardConfig shard.ShardConfig, err error) {
	err = c.wrapError(c.CallContext(ctx, &shardConfig, "zgs_getShardConfig"), "zgs_getShardConfig")
	return
}
